 ...
 * older platforms.
 * <p>
 * Note that for now this is not publicly available because it is not a complete implementation, only sufficient for the needs of {@link AsyncTaskLoader}.
 */
abstract class ModernAsyncTask<Params, Progress, Result> {
     ...
     * @throws IllegalStateException If {@link #getStatus()} returns either {@link android.os.AsyncTask.Status#RUNNING} or {@link android.os.AsyncTask.Status#FINISHED}.
     */
     ...
     * still running. Each call to this method will trigger the execution of {@link #onProgressUpdate} on the UI thread. {@link #onProgressUpdate} will note be called if the task has been
     * canceled.
     * 
